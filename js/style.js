...
$(function(){
  $(".typed-effect").typed({
    strings: ["Hi! It's my Portfolio", "I'M Puneet Sharma"], // ^{number} denotes time in ms to wait
    ...
    callback: function() {
      ...
      setTimeout (function () {
        $('.typed-effect + .typed-cursor').css({'opacity': '1', 'animation': 'none'});
      }, 1300);
  ...
  setTimeout ( function() {
    $(".testing-typed").typed({
    strings: ["UI Designer Faridabad, Haryana"], // ^{number} denotes time in ms to wait
